...
exports.update = async(req, res) => {
  ...
  try {
    ...
    console.log("Problem updating the product: ", err)
    res.status(400).json({status: false, data: err});
  }
}
...
exports.delete = async(req, res) => {
  ...
  console.log("Delete product from user ", username, " with id: ", product_id);
  ...
  try {
    ...
    console.log("Problem in deleting product from user.", err);
    res.status(400).json({status: false, data: err})
  }
}
